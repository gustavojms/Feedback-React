...
export function FeedbackSucessStep({ onFeedbackRestartRequest }: FeedbackSucessStepProps) {
    return (
        <>
            ...
            className="py-2 px-6 mt-6 bg-zinc-800 rounded-md border-transparent text-sm leading-6 hover:bg-zinc-700 focus:border-brand-500 focus:ring-brand-500 focus:ring-1 focus:outline-none transition-colors">
                Quero enviar outro
            </button>
            </div>
        </>
